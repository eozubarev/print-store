import { u as useHead, m as mergeConfig, b as appConfig, c as __nuxt_component_0$1$1, d as useUI, h as defineStore, _ as _export_sfc, f as useNuxtApp, g as useRuntimeConfig, a as __nuxt_component_0$4 } from './server.mjs';
import { defineComponent, ref, computed, h as h$1, useSSRContext, toRef, onMounted, onUnmounted, Fragment, watchEffect, watch, provide, unref, inject, getCurrentInstance, Teleport, reactive, normalizeClass, mergeProps, withCtx, createTextVNode, cloneVNode, nextTick, createVNode, resolveDynamicComponent, renderSlot, shallowRef, resolveComponent, openBlock, createBlock, createCommentVNode, toDisplayString } from 'vue';
import { E as encodeParam, F as isEqual, o as hasProtocol, G as withLeadingSlash, p as joinURL, q as parseURL, n as defu, H as encodePath } from '../runtime.mjs';
...
const ipxRuntime$kL5E85svTD = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  getImage,
  supportsAlias,
  validateDomains
...
imageOptions.providers = {
  ["ipx"]: { provider: ipxRuntime$kL5E85svTD, defaults: {} }
};
const useImage = () => {
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  const _component_UIcon = __nuxt_component_0$1$1;
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CardShop/CardShopBuy.vue");
  return _sfc_setup$2 ? _sfc_setup$2(props, ctx) : void 0;
};
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-914eeaea"]]);
function t$5(e2) {
...
const usePrintStore = defineStore("prints", {
  state: () => ({
    initialLoad: false,
    prints: printsData
  }),
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "card__price" }, _attrs))} data-v-97aa3f97>${ssrInterpolate(Math.trunc(props.price).toLocaleString("ru-RU"))} \u20BD </div>`);
    };
  }
});
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CardShop/CardShopPrice.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-97aa3f97"]]);

export { __nuxt_component_1 as _, __nuxt_component_0$2 as a, __nuxt_component_2 as b, __nuxt_component_3 as c, usePrintStore as u };
//# sourceMappingURL=CardShopPrice-Q2wmP61u.mjs.map
