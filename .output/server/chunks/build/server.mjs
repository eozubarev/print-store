import { hasInjectionContext, inject, version, ref, watchEffect, watch, getCurrentInstance, defineComponent, provide, createElementBlock, defineAsyncComponent, useAttrs, computed, toValue, toRef, useSSRContext, h, unref, shallowReactive, Suspense, nextTick, Transition, resolveComponent, createVNode, resolveDynamicComponent, mergeProps, withCtx, renderSlot, createTextVNode, toDisplayString, withAsyncContext, createApp, effectScope, reactive, isRef, isReactive, toRaw, onErrorCaptured, onServerPrefetch, getCurrentScope, onScopeDispose, shallowRef, isReadonly, toRefs, markRaw, isShallow } from 'vue';
import { $ as $fetch, l as defuFn, m as klona, n as defu, o as hasProtocol, p as joinURL, q as parseURL, r as parseQuery, t as createDefu, v as createHooks, h as createError$1, w as withQuery, x as isScriptProtocol, y as withTrailingSlash, z as withoutTrailingSlash, A as sanitizeStatusCode, B as isSamePath, C as toRouteMatcher, D as createRouter$1 } from '../runtime.mjs';
...
import { ssrRenderVNode, ssrRenderSlot, ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderSuspense } from 'vue/server-renderer';
...
const inlineConfig = {
  "nuxt": {
    "buildId": "7b674da0-4e01-4331-b815-b6fa1d2a3f16"
  },
  "ui": {
    "primary": "green",
    "gray": "cool",
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./about-wCYjGea9.mjs').then((m) => m.default || m)
  },
  {
    name: "contacts",
    path: "/contacts",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./contacts-ELKgrD5_.mjs').then((m) => m.default || m)
  },
  {
    name: "delivery",
    path: "/delivery",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./delivery-CSWfA3Ky.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-CIwa2g-t.mjs').then((m) => m.default || m)
  },
  {
    name: "product-id",
    path: "/product/:id()",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./_id_-CH5VbJ3v.mjs').then((m) => m.default || m)
  },
  {
    name: "product",
    path: "/product",
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BULy7fxj.mjs').then((m) => m.default || m)
  }
];
...
const client_A25i47TKRZ = /* @__PURE__ */ defineNuxtPlugin({
  name: "my-plugin",
  enforce: "pre",
  // or 'post'
  async setup(nuxtApp) {
...
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-CJtkKzgl.mjs').then((r) => r["default"] || r.default || r));
...
const serverSidePlugin = async (context, inject2) => {
};
const plugins = [
  unhead_KgADcZ0jPj,
  plugin$1,
...
const __nuxt_component_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$4]]);
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  __name: "HeaderShopNav",
  __ssrInlineRender: true,
  setup(__props) {
    const langStore = useLangStore();
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$4;
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "nav" }, _attrs))} data-v-a96ed23f><div class="nav_container" data-v-a96ed23f>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/about" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(langStore).lang === unref(Language).RU ? "Обо мне" : "About me")}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(langStore).lang === unref(Language).RU ? "Обо мне" : "About me"), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/delivery" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(langStore).lang === unref(Language).RU ? "Доставка" : "Delivery")}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(langStore).lang === unref(Language).RU ? "Доставка" : "Delivery"), 1)
            ];
          }
        }),
        _: 1
      ...
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/contacts" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(unref(langStore).lang === unref(Language).RU ? "Контакты" : "Contacts")}`);
          } else {
            return [
              createTextVNode(toDisplayString(unref(langStore).lang === unref(Language).RU ? "Контакты" : "Contacts"), 1)
            ];
          }
        }),
        _: 1
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/HeaderShop/HeaderShopNav.vue");
  return _sfc_setup$b ? _sfc_setup$b(props, ctx) : void 0;
};
const HeaderShopNav = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-a96ed23f"]]);
const _sfc_main$a = {};
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$4;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "header_logo" }, _attrs))} data-v-ecd88ee0>`);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` евгений<br data-v-ecd88ee0${_scopeId}> зубарев `);
      } else {
        return [
          createTextVNode(" евгений"),
          createVNode("br"),
          createTextVNode(" зубарев ")
        ];
      }
    }),
    _: 1
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/HeaderShop/HeaderShopLogo.vue");
  return _sfc_setup$a ? _sfc_setup$a(props, ctx) : void 0;
};
const HeaderShopLogo = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-ecd88ee0"]]);
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__scopeId", "data-v-e8d572f6"]]);
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/HeaderShop/HeaderShopSocials.vue");
  return _sfc_setup$7 ? _sfc_setup$7(props, ctx) : void 0;
};
const HeaderShopSocials = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-2f3ec596"]]);
const useColorMode = () => {
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ColorMode/ColorMode.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const activeClass = "lang_active";
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  __name: "CommonShopLang",
  __ssrInlineRender: true,
  setup(__props) {
    const langStore = useLangStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "lang" }, _attrs))} data-v-2d903d87><div class="${ssrRenderClass(unref(langStore).lang === unref(Language).RU ? activeClass : "")}" data-v-2d903d87>Ru </div><div class="${ssrRenderClass(unref(langStore).lang === unref(Language).ENG ? activeClass : "")}" data-v-2d903d87> Eng </div></div>`);
    };
  }
});
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/CommonShop/CommonShopLang.vue");
  return _sfc_setup$5 ? _sfc_setup$5(props, ctx) : void 0;
};
const CommonShopLang = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-2d903d87"]]);
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  __name: "HeaderShopSettings",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "header-settings" }, _attrs))} data-v-ff948bba>`);
      _push(ssrRenderComponent(_sfc_main$6, null, null, _parent));
      _push(ssrRenderComponent(HeaderShopSocials, null, null, _parent));
      _push(ssrRenderComponent(CommonShopLang, { class: "header-settings_lang" }, null, _parent));
      _push(`</div>`);
    };
  }
});
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/HeaderShop/HeaderShopSettings.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const HeaderShopSettings = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-ff948bba"]]);
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-add0b35a>`);
      _push(ssrRenderComponent(_component_UContainer, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="header_container" data-v-add0b35a${_scopeId}>`);
            _push2(ssrRenderComponent(HeaderShopLogo, null, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(HeaderShopNav, null, null, _parent2, _scopeId));
            _push2(ssrRenderComponent(HeaderShopSettings, null, null, _parent2, _scopeId));
            _push2(`</div>`);
          } else {
            return [
              createVNode("div", { class: "header_container" }, [
                createVNode(HeaderShopLogo),
                createVNode(HeaderShopNav),
                createVNode(HeaderShopSettings)
              ])
            ];
          }
        }),
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/HeaderShop/HeaderShop.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-add0b35a"]]);
const layouts = {
  default: () => import('./default-CfW7zP8D.mjs').then((m) => m.default || m),
  error: () => import('./error-3ouOQDFK.mjs').then((m) => m.default || m)
};
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_HeaderShop = __nuxt_component_0;
  const _component_NuxtLayout = __nuxt_component_1;
  const _component_NuxtPage = __nuxt_component_2;
  _push(`<!--[-->`);
  _push(ssrRenderComponent(_component_HeaderShop, null, null, _parent));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DMwQTVy1.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-BHq5mPvq.mjs').then((r) => r.default || r));
...
export { _export_sfc as _, __nuxt_component_0$4 as a, appConfig as b, __nuxt_component_0$1 as c, useUI as d, entry$1 as default, useRoute as e, useNuxtApp as f, useRuntimeConfig as g, defineStore as h, useAppConfig as i, __nuxt_component_0$3 as j, mergeConfig as m, resolveIconName as r, useHead as u };
